...
export const CAROUSEL_PROJECTS: CarouselProject[] = [
  ...
  {
    name: 'ExportDesk — CRM',
    desc: 'A lightweight CRM for Taiwanese export manufacturers and trading SMEs — buyers, deal pipeline, quotations with A4 print, bilingual EN/繁中 UI, and AI inquiry parsing. Built for teams managing buyers in Excel, Outlook and LINE.',
    tags: ['Next.js', 'TypeScript', 'Supabase', 'SaaS'],
    badge: 'CODE',
    category: 'SAAS · CRM',
    year: '2026',
    color: '#f97316',
    note: 'Private repo — live demo on request',
    board: [
      {
        kind: 'fact',
        label: 'THE GAP',
        text: 'Taiwanese export SMEs manage international buyers in Excel, Outlook and LINE — Salesforce is overkill and overpriced. ExportDesk is the right-sized middle.',
        x: 16, y: 17,
      },
      {
        kind: 'fact',
        label: 'THE PRODUCT',
        text: 'Buyers, contacts, a drag-and-drop deal pipeline (kanban), activities & follow-ups, and quotations with print-ready A4 output.',
        x: 48, y: 11,
      },
      {
        kind: 'stat',
        label: 'LANGUAGE',
        title: 'EN/繁中',
        text: 'Fully bilingual UI — built for how Taiwanese trading teams actually work.',
        x: 80, y: 17,
      },
      {
        kind: 'fact',
        label: 'AI INSIDE',
        text: 'Optional Claude-powered inquiry parsing — paste a buyer email, get a structured lead: company, contact, product, quantity.',
        x: 14, y: 62,
      },
      {
        kind: 'tags',
        label: 'STACK',
        tags: ['Next.js 15', 'TypeScript strict', 'Supabase + RLS', 'Tailwind v4', 'shadcn/ui', 'zod'],
        x: 85, y: 55,
      },
      {
        kind: 'fact',
        label: 'BUILT RIGHT',
        text: 'Row-level security, CSV import/export, seeded demo data, zod-validated forms — production patterns, not a prototype.',
        x: 38, y: 84,
      },
      {
        kind: 'stat',
        label: 'STATUS',
        title: '2026',
        text: 'In active development — private repo, live demo available on request.',
        x: 72, y: 82,
      },
    ],
  },
