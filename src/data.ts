...
export const CAROUSEL_PROJECTS: CarouselProject[] = [
  ...
  {
    name: 'English Reader',
    desc: 'A graded-reader web app for learning English, built for Chinese speakers — 25 original stories across 5 books (A1 to B1+), with word-by-word Chinese glosses and full Simplified/Traditional support.',
    tags: ['JavaScript', 'EdTech', '简/繁'],
    live: 'https://notdeepan.github.io/english-reader/',
    repo: 'https://github.com/notDeepan/english-reader',
    badge: 'LIVE',
    category: 'EDTECH · WEB APP',
    year: '2026',
    color: '#f97316',
    image: '/posters/english.jpg',
    board: [
      {
        kind: 'fact',
        label: 'THE MIRROR',
        text: 'After building Mandarin Reader for English speakers, Deepan flipped the formula: the same graded-story method, rebuilt for Chinese speakers learning English.',
        x: 20, y: 16,
      },
      {
        kind: 'stat',
        label: 'THE LIBRARY',
        title: '25',
        text: 'original chapters across 5 complete books — from a lost cat (A1) to a lighthouse keeper’s last watch (B1+).',
        x: 74, y: 15,
      },
      {
        kind: 'fact',
        label: 'HOW IT TEACHES',
        text: 'Word-by-word Chinese glosses above every English word in beginner stories, full sentence translations, and grammar notes — comprehension never breaks.',
        x: 16, y: 70,
      },
      { kind: 'tags', label: 'STACK', tags: ['JavaScript', '简/繁 Toggle', 'GitHub Pages'], x: 47, y: 85 },
      {
        kind: 'stat',
        label: 'STATUS',
        title: 'LIVE',
        text: 'Deployed and public — free, no signup. Start reading from this board.',
        x: 78, y: 76,
      },
    ],
  },
