...
const zh: ContentT = {
  ...
  projects: [
    ...
    {
      category: 'SAAS · CRM 系統',
      desc: '為台灣出口製造商與貿易中小企業打造的輕量 CRM——買家管理、交易管線、A4 列印報價單、中英雙語介面與 AI 詢價解析。專為還在用 Excel、Outlook 和 LINE 管理買家的團隊而生。',
      board: [
        { l: '市場缺口', t: '台灣出口中小企業用 Excel、Outlook 和 LINE 管理國際買家——Salesforce 太重也太貴。ExportDesk 是剛剛好的中間解。' },
        { l: '產品', t: '買家、聯絡人、拖放式交易看板（kanban）、活動與跟進紀錄，以及可直接列印 A4 的報價單。' },
        { l: '語言', t: '完整雙語介面——為台灣貿易團隊真實的工作方式而設計。' },
        { l: '內建 AI', t: '選配 Claude 詢價解析——貼上買家郵件，自動產出結構化商機：公司、聯絡人、產品、數量。' },
        { l: '技術棧' },
        { l: '扎實工程', t: '資料列級安全（RLS）、CSV 匯入匯出、示範資料種子、zod 表單驗證——是生產級模式，不是原型。' },
        { l: '狀態', t: '積極開發中——私有倉庫，可依需求提供線上示範。' },
      ],
    },
    {
      category: '教育科技 · 網頁應用',
...
const ja: ContentT = {
  ...
  projects: [
    ...
    {
      category: 'SAAS · CRM',
      desc: '台湾の輸出メーカー・貿易中小企業向けの軽量CRM——バイヤー管理、商談パイプライン、A4印刷対応の見積書、英・繁体字中国語の二言語UI、AIによる引き合い解析。ExcelとOutlookとLINEでバイヤーを管理しているチームのために。',
      board: [
        { l: '市場の空白', t: '台湾の輸出中小企業はExcel・Outlook・LINEで海外バイヤーを管理——Salesforceは重すぎて高すぎる。ExportDeskはちょうどいい中間解。' },
        { l: 'プロダクト', t: 'バイヤー、連絡先、ドラッグ&ドロップの商談カンバン、活動とフォローアップ、A4印刷対応の見積書。' },
        { l: '言語', t: '完全二言語UI——台湾の貿易チームの実際の働き方に合わせて設計。' },
        { l: 'AI搭載', t: 'オプションのClaude引き合い解析——バイヤーのメールを貼り付けると、会社・担当者・製品・数量が構造化リードに。' },
        { l: '技術スタック' },
        { l: '堅実な設計', t: '行レベルセキュリティ（RLS）、CSVインポート/エクスポート、デモデータのシード、zodフォーム検証——プロトタイプではなく本番パターン。' },
        { l: 'ステータス', t: '鋭意開発中——プライベートリポジトリ、デモはリクエストで提供。' },
      ],
    },
    {
...
const ko: ContentT = {
  ...
  projects: [
    ...
    {
      category: 'SAAS · CRM',
      desc: '대만 수출 제조업체와 무역 중소기업을 위한 경량 CRM——바이어 관리, 딜 파이프라인, A4 인쇄 견적서, 영어/번체 중국어 이중 UI, AI 문의 파싱. Excel·Outlook·LINE으로 바이어를 관리하는 팀을 위해.',
      board: [
        { l: '시장 공백', t: '대만 수출 중소기업은 Excel·Outlook·LINE으로 해외 바이어를 관리——Salesforce는 과하고 비싸다. ExportDesk는 딱 맞는 중간 해법.' },
        { l: '제품', t: '바이어, 연락처, 드래그 앤 드롭 딜 칸반, 활동·팔로우업, A4 인쇄 가능한 견적서.' },
        { l: '언어', t: '완전한 이중 언어 UI——대만 무역 팀의 실제 업무 방식에 맞춰 설계.' },
        { l: 'AI 내장', t: '선택형 Claude 문의 파싱——바이어 이메일을 붙여넣으면 회사·담당자·제품·수량이 구조화된 리드로.' },
        { l: '기술 스택' },
        { l: '탄탄한 설계', t: '행 수준 보안(RLS), CSV 가져오기/내보내기, 데모 데이터 시드, zod 폼 검증——프로토타입이 아닌 프로덕션 패턴.' },
        { l: '상태', t: '활발히 개발 중——비공개 저장소, 요청 시 라이브 데모 제공.' },
      ],
    },
    {
      category: '에듀테크 · 웹앱',
...
const vi: ContentT = {
  ...
  projects: [
    ...
    {
      category: 'SAAS · CRM',
      desc: 'CRM gọn nhẹ cho nhà sản xuất xuất khẩu và SME thương mại Đài Loan——quản lý người mua, pipeline giao dịch, báo giá in A4, giao diện song ngữ Anh/Trung phồn thể, và phân tích thư hỏi hàng bằng AI. Dành cho các đội đang quản lý người mua bằng Excel, Outlook và LINE.',
      board: [
        { l: 'KHOẢNG TRỐNG', t: 'SME xuất khẩu Đài Loan quản lý người mua quốc tế bằng Excel, Outlook và LINE——Salesforce quá nặng và quá đắt. ExportDesk là giải pháp vừa vặn ở giữa.' },
        { l: 'SẢN PHẨM', t: 'Người mua, liên hệ, bảng kanban giao dịch kéo-thả, hoạt động & theo dõi, và báo giá in A4 sẵn sàng.' },
        { l: 'NGÔN NGỮ', t: 'Giao diện song ngữ hoàn chỉnh——thiết kế theo đúng cách các đội thương mại Đài Loan làm việc.' },
        { l: 'AI TÍCH HỢP', t: 'Phân tích thư hỏi hàng bằng Claude (tùy chọn)——dán email người mua, nhận lead có cấu trúc: công ty, liên hệ, sản phẩm, số lượng.' },
        { l: 'CÔNG NGHỆ' },
        { l: 'XÂY CHUẨN', t: 'Bảo mật cấp hàng (RLS), nhập/xuất CSV, dữ liệu demo, kiểm tra form bằng zod——mẫu hình production, không phải nguyên mẫu.' },
        { l: 'TRẠNG THÁI', t: 'Đang phát triển tích cực——kho riêng tư, demo trực tiếp theo yêu cầu.' },
      ],
    },
    {
...
const id: ContentT = {
  ...
  projects: [
    ...
    {
      category: 'SAAS · CRM',
      desc: 'CRM ringan untuk produsen ekspor dan UKM dagang Taiwan——manajemen pembeli, pipeline transaksi, penawaran siap cetak A4, UI dwibahasa Inggris/Mandarin tradisional, dan penguraian inkuiri berbasis AI. Untuk tim yang masih mengelola pembeli lewat Excel, Outlook, dan LINE.',
      board: [
        { l: 'CELAH PASAR', t: 'UKM ekspor Taiwan mengelola pembeli internasional lewat Excel, Outlook, dan LINE——Salesforce terlalu berat dan mahal. ExportDesk adalah solusi tengah yang pas.' },
        { l: 'PRODUK', t: 'Pembeli, kontak, kanban transaksi seret-lepas, aktivitas & tindak lanjut, serta penawaran siap cetak A4.' },
        { l: 'BAHASA', t: 'UI dwibahasa penuh——dirancang sesuai cara kerja nyata tim dagang Taiwan.' },
        { l: 'AI TERPASANG', t: 'Penguraian inkuiri Claude (opsional)——tempel email pembeli, dapatkan lead terstruktur: perusahaan, kontak, produk, kuantitas.' },
        { l: 'TEKNOLOGI' },
        { l: 'DIBANGUN BENAR', t: 'Keamanan tingkat baris (RLS), impor/ekspor CSV, data demo, validasi form zod——pola produksi, bukan prototipe.' },
        { l: 'STATUS', t: 'Dalam pengembangan aktif——repo privat, demo langsung berdasarkan permintaan.' },
      ],
    },
    {
