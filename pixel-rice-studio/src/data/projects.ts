...
export const projects:Project[] = [
  {id:'kaoming',title:'KAO MING',category:'INDUSTRIAL · DIGITAL SHOWROOM',description:'A bilingual digital showroom that turns complex machinery into an intuitive, interactive product journey.',technologies:['Next.js','TypeScript','React Three Fiber','next-intl'],cover:assetPath('/assets/projects/kaoming-live.webp'),coverKind:'screenshot',liveUrl:'https://notdeepan.github.io/kaoming-website/',private:true,status:'Website preview · source kept private'},
  {id:'sunset',title:'Cijin Sunset Bar',category:'HOSPITALITY · WEB EXPERIENCE',description:'From a beachfront sunset to the afterparty. A bilingual day-to-night experience for Cijin Sunset Bar and Brickyard.',technologies:['Next.js','React Three Fiber','GSAP','next-intl'],cover:assetPath('/assets/projects/sunset-live.webp'),coverKind:'screenshot',liveUrl:'https://notdeepan.github.io/cijin-sunset/',status:'Website concept · content awaiting confirmation'},
  ...
  {id:'tide-house',title:'Tide House',category:'HOSPITALITY · STUDIO DEMO',description:'An inviting stay, before you arrive. A bilingual guesthouse concept with availability, booking requests and ferry directions.',technologies:['HTML','CSS','JavaScript'],cover:assetPath('/assets/projects/tide-house-live.webp'),coverKind:'screenshot',liveUrl:'https://notdeepan.github.io/kaohsiung-demos/bnb/',status:'Studio demo · fictional business'},
  {id:'takao',title:'Takao Pantry',category:'COMMERCE · STUDIO DEMO',description:'A specialty food and gifting concept with a bilingual storefront, currency switching and a demonstration checkout.',technologies:['HTML','CSS','JavaScript'],cover:assetPath('/assets/projects/takao-live.webp'),coverKind:'screenshot',liveUrl:'https://notdeepan.github.io/kaohsiung-demos/shop/',status:'Studio demo · fictional business'},
];
